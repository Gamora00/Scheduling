...
exports.UnarchiveStudent = async (req, res) => {
    ...
    try {
        ...
        await connection.query(`
            INSERT INTO student (student_id, first_name, last_name, middle_name, strand, grade_level, section, parents_name, parent_number, student_username, student_password, address)
